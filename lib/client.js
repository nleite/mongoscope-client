...
Client.prototype.destroyCollection = function(db, col, fn){
  return this.crud('del', '/' + db + '/' + col, {}, fn);
};

Client.prototype.updateCollection = function(db, col, data, fn){
  return this.crud('put', '/' + db + '/' + col, data, fn);
};
...
Client.prototype.index = function(db, col, name, fn){
  return this.read('/' + db + '/' + col + '/indexes/' + name, {}, fn);
};
...
opts = opts || {};
  ...
  return this.crud('post', '/' + db + '/' + col + '/indexes', params, fn);
};
...
Client.prototype.sample = function(db, collection, opts, fn){
  ...
  return this.read('/' + db + '/' + collection + '/sample', {
    size: opts.size || 5
  }, fn);
};
