...
Client.prototype.collection = function collection(db, col, opts, fn){
  ...
  return this.read('/collections/' + db + '.' + col, opts, fn);
};

Client.prototype.createCollection = function(db, col, opts, fn){
  opts = opts || {};
  if(typeof opts === 'function'){
    fn = opts;
    opts = {};
  }
  return this.crud('post', '/collections/' + db, {
    name: col,
...
Client.prototype.destroyCollection = function(db, col, fn){
  return this.crud('del', '/collections/' + db + '.' + col, {}, fn);
};

Client.prototype.updateCollection = function(db, col, data, fn){
  return this.crud('put', '/collections/' + db + '.' + col, data, fn);
};
 ...
 * @stability prototype
 */
Client.prototype.index = function(db, col, name, fn){
  return this.read('/indexes/' + db + '.' + col + '/' + name, {}, fn);
};

Client.prototype.createIndex = function(db, col, name, opts, fn){
  opts = opts || {};
  if(typeof opts === 'function'){
    fn = opts;
    opts = {};
  ...
  return this.crud('post', '/indexes/' + db + '.' + col, params, fn);
};

Client.prototype.updateIndex = function(db, col, name, opts, fn){
  opts = opts || {};
  if(typeof opts === 'function'){
    fn = opts;
    opts = {};
  ...
  var params = {field: name, options: opts};
  return this.crud('put', '/indexes/' + db + '.' + col, params, fn);
};

Client.prototype.destroyIndex = function(db, col, name, fn){
  return this.crud('del','/indexes/' + db + '.' + col +  '/' + name, {}, fn);
};

Client.prototype.getDocument = function(db, col, _id, fn){
  return this.read('/documents/' + db + '.' + col + '/' + _id, {}, fn);
};

Client.prototype.updateDocument = function(db, col, _id, data, fn){
  return this.crud('put', '/documents/' + db + '.' + col + '/' + _id, data, fn);
};

Client.prototype.createDocument = function(db, col, data, fn){
  return this.crud('post', '/documents/' + db + '.' + col, data, fn);
};

Client.prototype.destroyDocument = function(db, col, _id, fn){
  return this.crud('del', '/documents/' + db + '.' + col + '/' + _id, {}, fn);
};
...
Client.prototype.count = function(db, collection, opts, fn){
  ...
  return this.read('/collections/' + db + '.' + collection + '/count', params, fn);
};
...
Client.prototype.aggregate = function(db, collection, pipeline, opts, fn){
  ...
  return this.read('/collections/' + db + '.' + collection + '/aggregate', {
...
Client.prototype.sample = function(db, collection, opts, fn){
  ...
  return this.read('/collections/' + db + '.' + collection + '/sample', {
    size: opts.size || 5
  }, fn);
};
